...
namespace OpenAi.Unity
{
    ...
    public abstract class NewAMonoSingleton<T> : MonoBehaviour
        where T : NewAMonoSingleton<T>
    {
        ...
        public static T Instance
        {
            get
            {
                if (AppQuitting)
                {
                    Debug.LogWarning($"No {nameof(NewAMonoSingleton<T>)} returned because application is quiting");
                    return null;
                }
