...
namespace OpenAi.Unity.V1
{
    ...
    /// </summary>
    public class NewAiCompleterV1 : NewAMonoSingleton<NewAiCompleterV1>
    {
        ...
        public ENewEngineName Engine = ENewEngineName.davinci;
        ...
        public void Start()
        {
            ...
            _engine = _gateway.Api.Engines.Engine(NewUTEngineName.GetEngineName(Engine));
        }
